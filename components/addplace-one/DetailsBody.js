                                ...
                                <form onSubmit={this.onHandleSubmit}>
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="form-group">
                                                <input type="latitude" className="form-control" placeholder="Latitude" />
                                            </div>
                                        </div>
                                        
                                        <div className="col-lg-6 col-md-6">
                                            <div className="form-group">
                                                <input type="longtitude" className="form-control" placeholder="Longtitude" />
                                            </div>
                                        </div>

                                        <div className="col-lg-12 col-md-12 ptb-20">
                                            <Upload/>
                                        </div>
